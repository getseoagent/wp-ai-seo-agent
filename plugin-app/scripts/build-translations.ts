...
const TRANSLATIONS: Record<string, Catalog> = {
  ru: {
    ...
    "Message to the SEO agent":        "Сообщение SEO-агенту",
    "No messages yet — say hi to test the pipe.": "Сообщений пока нет — поздоровайтесь, чтобы проверить связь.",
    "Bulk job progress: %1$d of %2$d": "Прогресс массовой задачи: %1$d из %2$d",
  ...
  uk: {
    ...
    "Message to the SEO agent":        "Повідомлення SEO-агенту",
    "No messages yet — say hi to test the pipe.": "Повідомлень ще немає — привітайтеся, щоб перевірити зв'язок.",
    "Bulk job progress: %1$d of %2$d": "Прогрес масової задачі: %1$d з %2$d",
  ...
  es: {
    ...
    "Message to the SEO agent":        "Mensaje al agente SEO",
    "No messages yet — say hi to test the pipe.": "Aún no hay mensajes — saluda para comprobar la conexión.",
    "Bulk job progress: %1$d of %2$d": "Progreso de la tarea en lote: %1$d de %2$d",
  ...
  fr: {
    ...
    "Message to the SEO agent":        "Message à l'agent SEO",
    "No messages yet — say hi to test the pipe.": "Pas encore de messages — dites bonjour pour tester la connexion.",
    "Bulk job progress: %1$d of %2$d": "Progression de la tâche en lot : %1$d sur %2$d",
  ...
  pt_BR: {
    ...
    "Message to the SEO agent":        "Mensagem para o agente SEO",
    "No messages yet — say hi to test the pipe.": "Ainda não há mensagens — diga oi para testar a conexão.",
    "Bulk job progress: %1$d of %2$d": "Progresso da tarefa em lote: %1$d de %2$d",
